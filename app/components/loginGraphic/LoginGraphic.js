    ...
    return(
        <div className="relative flex h-full w-full">
            <div className="relative left-10 top-5">
                <Image src={EllipseWhite} width={250} alt="white elipse" />
            </div>
            ...
            <div className="absolute w-88 h-88 right-0 bottom-72 z-10 overflow-hidden">
                <Image src={EllipseOrange} width={300} alt="orange elipse" />
            </div>
            <div className="absolute bottom-0 right-0">
                <Image src={EllipseYellow} width={400} alt="yellow elipse" />
            </div>
        </div>
    )
}